...
#ifndef H_GIRAUNO_SCRIPT
#define H_GIRAUNO_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CGiraunoAddress
 */
...
public:
    ...
    // Pre-version-0.6, Girauno always counted CHECKMULTISIGs
