// Copyright (c) 2016-2019 The Girauno Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CGiraunoSecret::SetString tests isValid, whereas CGiraunoAddress does not!
