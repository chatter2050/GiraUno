...
#ifndef _GIRAUNORPC_CLIENT_H_
#define _GIRAUNORPC_CLIENT_H_ 1
...
/** Show help message for girauno-cli.
 ...
 *
 * @note the argument can be removed once girauno-cli functionality is removed from giraunod
 */
