...
#include "girauno-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGiraunoURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GiraunoUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGiraunoURI(info));
}
