...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/girauno"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Girauno"),
     ...
     * override -datadir in the girauno.conf file in the default data directory
     * (to be consistent with giraunod behavior)
     */
    if(dataDir != getDefaultDataDirectory())
