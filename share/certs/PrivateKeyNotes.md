...
unlocked to sign the Girauno-Qt.app bundle.
...
allowing somebody to distribute a Girauno-Qt.app or girauno-qt-setup.exe with a valid
...
that the girauno-qt.exe file inside the installer had not been tampered with.
