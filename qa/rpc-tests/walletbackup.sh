...
function StartThree {
  $GIRAUNOD $GIRAUNODARGS $B1ARGS &
  B1PID=$!
  $GIRAUNOD $GIRAUNODARGS $B2ARGS &
  B2PID=$!
  $GIRAUNOD $GIRAUNODARGS $B3ARGS &
  B3PID=$!
}
