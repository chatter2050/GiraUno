Girauno version 0.5.4 is now available for download at:
http://sourceforge.net/projects/girauno/files/Girauno/girauno-0.5.4/
...
http://gitorious.org/girauno/giraunod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Girauno-Qt notifications under Growl 1.3.
Increase required age of Girauno-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGirauno properly when installing Girauno-Qt over it. (Windows)
