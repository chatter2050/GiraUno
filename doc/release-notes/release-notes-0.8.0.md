Girauno-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/girauno/files/Girauno/girauno-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Girauno
...
New/changed settings (command-line or girauno.conf file)
--------------------------------------------------------
