Download URL: https://sourceforge.net/projects/girauno/files/Girauno/girauno-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GR1 fee schedule (users still pay 0.01 GR1 per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #girauno00 - #girauno99
