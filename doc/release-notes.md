Girauno Core version 0.9.4 is now available from:

  https://girauno.org/bin/0.9.4/
...
installer (on Windows) or just copy over /Applications/Girauno-Qt (on Mac) or
giraunod/girauno-qt (on Linux).
...
this update is incompatible with the Girauno system and could lead to consensus
forks.

Girauno Core released binaries from https://girauno.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~girauno/+archive/ubuntu/girauno
- A third-party or self-compiled Girauno Core

upgrade to Girauno Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/girauno/).
