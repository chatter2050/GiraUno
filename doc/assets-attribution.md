The following is a list of assets used in the girauno source and their proper attribution.
...
* License: MIT
* Site: [https://giraunotalk.org/index.php?topic=15276.0](https://giraunotalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original girauno logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/girauno.icns, src/qt/res/src/girauno.svg,
	src/qt/res/src/girauno.ico, src/qt/res/src/girauno.png,
	src/qt/res/src/girauno_testnet.png, docs/girauno_logo_doxygen.png,
